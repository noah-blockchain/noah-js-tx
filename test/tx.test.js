...
import {mPrefixToHex, convertToPip} from 'noahjs-util';
import {NoahTx, NoahTxSignature, NoahTxDataSend, TX_TYPE_SEND, coinToBuffer} from '~/src';
...
describe('tx', () => {
    ...
    tx.signatureData = (new NoahTxSignature()).sign(tx.hash(false), PRIVATE_KEY).serialize();
    const unsignedTx = new NoahTx(txParams);
    ...
    test('tx from string', () => {
        const txFromString = new NoahTx('');
